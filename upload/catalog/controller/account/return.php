	...
	public function index() {
		...
		foreach ($results as $result) {
            ...
            if ($product_info['image']) {
                ...
                $product_info['thumb'] = $this->model_tool_image->resize('placeholder.png', 100, 100);
            }

            if ($product_info['price']) {
                $product_info['price'] = $this->currency->format($order_info['total'], $order_info['currency_code'], $order_info['currency_value']);
            }
